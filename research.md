...
In my research, I explore the ways in which linguistic knowledge emerges in language models -- mostly from a usage-based and constructionist perspective. Lately, my research focus in this direction has been on very small language models trained with small amounts of data.

Apart from that, I also sometimes work on more general questions of language acquisition, or do Digital Humanities. 
